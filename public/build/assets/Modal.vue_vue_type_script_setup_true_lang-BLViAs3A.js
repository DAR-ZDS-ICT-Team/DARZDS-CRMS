import{s as R}from"./vue-multiselect.css_vue_type_style_index_0_src_true_lang-I0Dv5Nbk.js";import j from"./BySectionMonthly-CIFIS1b1.js";import{P as A}from"./index-DajnbktX.js";import{B as M,d as g,i as D,x as F,j as t,o as y,e as T,b as e,w as o,g as c,t as U,u as $,a as r,c as q,f as z,F as E}from"./app-8aEKDLY2.js";const I=r("span",{class:"text-h5"},"Select Assignatoree",-1),G=r("label",null,"Prepared By:",-1),H=r("label",null,"Noted By:",-1),J={style:{"text-align":"end"}},X=M({__name:"Modal",props:{form:{type:Object,default:null},assignatorees:{type:Object,default:null},user:{type:Object,default:null},value:{type:Boolean,default:!1},data:{type:Boolean},generated:{type:Boolean}},emits:["input"],setup(n,{emit:b}){const p=b,m=n,i=g(!1);D(()=>m.value,l=>{i.value=l});const d=F({prepared_by:m.user,noted_by:{}}),w=l=>{p("input",l)},x=g(!1),h=async()=>{x.value=!0,(await new A).print(document.querySelector(".print-id"),[` 
