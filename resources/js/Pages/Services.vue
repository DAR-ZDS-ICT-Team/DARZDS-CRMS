...
const goToService = (office_id, division_id, section_id, service_id) => {
    router.get('/divisions/csf/services/check-sub-services', {
        office_id,
        division_id,
        section_id,
        service_id
    ...
    <v-container fill-height>
        ...
        <v-row class="mx-10 mt-5" justify="center" align="center">
            <v-col 
                ...
                <Link @click="goToService(office_id, division_id, section_id, service.id)" class="card-link">
